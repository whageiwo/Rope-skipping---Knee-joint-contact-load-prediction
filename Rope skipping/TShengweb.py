...
# ------------------ 页面配置 ------------------
st.set_page_config(page_title="跳绳运动-膝关节接触负荷预测", layout="wide")
...
# ------------------ 页面标题 ------------------
st.markdown(
    "<h1 style='text-align: center; color: darkred; margin-bottom: 40px;'>跳绳运动-膝关节接触负荷预测</h1>",
    unsafe_allow_html=True
)

# ------------------ 加载模型 ------------------
MODEL_PATH = "TSheng_XGJ_model.bin"
...
with col2:
    ...
    st.markdown(
        f"<p style='color:blue; font-size:40px; font-weight:bold;'>膝关节接触负荷: {pred:.2f}</p>",
        unsafe_allow_html=True
    )
